...
const DATE_FORMET_PATTERN = 'YYYY_MM_DD HH:mm:ss';
...
const showRemainingTime = (dateInFuture) => {
  ...
  if (dateNow >= dateInFuture) {
    ...
    const currentDateFormatted = moment(dateNow, DATE_FORMET_PATTERN);
    const futureDateFormatted = moment(dateInFuture, DATE_FORMET_PATTERN);
